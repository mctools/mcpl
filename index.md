...
* May 23, 2025:
  [v2.2.0](https://github.com/mctools/mcpl/releases/tag/v2.2.0) released, adding
  a few utility functions to the C API, facilitating easier creation of MCPL
  output bindings in MPI jobs.
* May 17, 2025:
